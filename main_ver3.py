...
class Logger(object):
    ...
    def display(self):
        ...
        plt.plot(self.subgoals_p.T[0], self.subgoals_p.T[1], "^",
                 label="Goal")
...
#   bさんはutilityに基づいて，経路計画する
    planner_a = \
        partner_and_self_anticipation_planner.PartnerSelfAnticipationPlanner(
                ...
                relative_angle_a)
    human_a = Robot(
        trajectory_a, trajectory_b, subgoals_p, obstacles_p, planner_a)

    human_b = Human(trajectory_b, trajectory_a, subgoals_p)
